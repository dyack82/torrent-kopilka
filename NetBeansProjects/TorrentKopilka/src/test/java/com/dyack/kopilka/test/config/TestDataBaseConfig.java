package com.dyack.kopilka.test.config;
...
public class TestDataBaseConfig {
    ...
    private static final String PROPERTY_NAME_DATABASE_URL = "jdbc:mysql://localhost:3306/kopilka";
    private static final String PROPERTY_NAME_DATABASE_USERNAME = "root";
    private static final String PROPERTY_NAME_DATABASE_PASSWORD = "admin";

    private static final String PROPERTY_NAME_HIBERNATE_DIALECT = "org.hibernate.dialect.MySQLDialect";
    private static final String PROPERTY_NAME_HIBERNATE_SHOW_SQL = "true";
    private static final String PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN = "com.dyack.kopilka.entity";
